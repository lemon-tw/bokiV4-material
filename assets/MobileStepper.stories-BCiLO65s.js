import{j as o}from"./jsx-runtime-BO8uF4Og.js";import{r as L,R as F}from"./index-D4H_InIO.js";import{g as et,b as rt,s as m,c as T,a as ot,m as S,e as mt}from"./memoTheme-C83d1A0S.js";import{u as P}from"./useSlot-BWf5NxIe.js";import{u as at,c as l,l as bt,j as vt}from"./DefaultPropsProvider-D4sChuSN.js";import{P as nt}from"./Paper-B8zVEXaw.js";import{u as ft}from"./index-Bm8UbI65.js";import{c as C}from"./createSimplePaletteValueFilter-bm0fmN_7.js";import{c as O,k as W}from"./useEnhancedEffect-BUbyLjya.js";import{B as h}from"./Button-SgMA5SmR.js";import{u as U}from"./useTheme-CfJJ7vPb.js";import{B as E}from"./Box-BuA1DgQs.js";import{T as ht}from"./Typography-D9Rxpb2u.js";import{a as g,C as x}from"./CaretRight.esm-QHyypDvM.js";import"./defaultPalette-fWaDn0-C.js";import"./Button-B10i2C5F.js";import"./useId-CN9_kA9R.js";import"./ButtonBase-CP1Oo1Bo.js";import"./TransitionGroupContext-DUOgHM_c.js";import"./CircularProgress-Cn6m69C4.js";import"./useTheme-Bh-_xkMb.js";import"./extendSxProp-BVuH4Y-a.js";import"./index-zquPRXLs.js";import"./IconBase.esm-BbKRF193.js";function gt(e){return et("MuiLinearProgress",e)}rt("MuiLinearProgress",["root","colorPrimary","colorSecondary","determinate","indeterminate","buffer","query","dashed","dashedColorPrimary","dashedColorSecondary","bar","bar1","bar2","barColorPrimary","barColorSecondary","bar1Indeterminate","bar1Determinate","bar1Buffer","bar2Indeterminate","bar2Buffer"]);const I=4,D=W`
  0% {
    left: -35%;
    right: 100%;
  }
    ...
    return <Box sx={{
      ...
      flexGrow: 1
        ...
        <MobileStepper variant="text" steps={maxSteps} position="static" activeStep={activeStep} nextButton={<Button variant="text" onClick={handleNext} disabled={activeStep === maxSteps - 1}>\r
              Next\r
              {theme.direction === "rtl" ? <CaretLeft /> : <CaretRight />}\r
            </Button>} backButton={<Button variant="text" onClick={handleBack} disabled={activeStep === 0}>\r
              {theme.direction === "rtl" ? <CaretRight /> : <CaretLeft />}\r
              Back\r
            </Button>} />\r
      </Box>;
  }
...
}`,...(tt=(Z=M.parameters)==null?void 0:Z.docs)==null?void 0:tt.source}}};const ie=["Text","Dots","Progress"];export{A as Dots,M as Progress,j as Text,ie as __namedExportsOrder,se as default};
