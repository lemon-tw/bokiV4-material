import{j as r}from"./jsx-runtime-BO8uF4Og.js";import{fn as ra}from"./index-Cf3xVBfy.js";import{u as ta}from"./DefaultPropsProvider-B0z8ytDR.js";import{ak as sa,al as ea,am as oa,an as na,z as ca,E,H as ia,K as la,ao as pa,A as n,ag as W}from"./Calendar-DbyfRCKY.js";import{r as p}from"./index-D4H_InIO.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";function da(a){return ea("MuiAvatarGroup",a)}const ma=sa("MuiAvatarGroup",["root","avatar"]),y={small:-16,medium:-8},ua=a=>{const{classes:s}=a;return ia({root:["root"],avatar:["avatar"]},da,s)},ga=ca("div",{name:"MuiAvatarGroup",slot:"Root",overridesResolver:(a,s)=>[{[`& .${ma.avatar}`]:s.avatar},s.root]})(la(({theme:a})=>({display:"flex",flexDirection:"row-reverse",[`& .${pa.root}`]:{border:`2px solid ${(a.vars||a).palette.background.default}`,boxSizing:"content-box",marginLeft:"var(--AvatarGroup-spacing, -8px)","&:last-child":{marginLeft:0}}}))),va=p.forwardRef(function(s,w){const G=ta({props:s,name:"MuiAvatarGroup"}),{children:Y,className:L,component:C="div",componentsProps:c,max:b=5,renderSurplus:R,slotProps:S={},slots:D={},spacing:F="medium",total:H,variant:A="circular",...j}=G;let e=b<2?2:b;const t={...G,max:b,spacing:F,component:C,variant:A},h=ua(t),x=p.Children.toArray(Y).filter(o=>p.isValidElement(o)),i=H||x.length;i===e&&(e+=1),e=Math.min(i+1,e);const I=Math.min(x.length,e-1),f=Math.max(i-e,i-I,0),B=R?R(f):`+${f}`;let l;t.spacing&&y[t.spacing]!==void 0?l=y[t.spacing]:t.spacing===0?l=0:l=-t.spacing||y.medium;const X={slots:D,slotProps:{surplus:S.additionalAvatar??(c==null?void 0:c.additionalAvatar),...c,...S}},[Z,aa]=oa("surplus",{elementType:na,externalForwardedProps:X,className:h.avatar,ownerState:t,additionalProps:{variant:A}});return r.jsxs(ga,{as:C,ownerState:t,className:E(h.root,L),ref:w,...j,style:{"--AvatarGroup-spacing":`${l}px`,...j.style},children:[f?r.jsx(Z,{...aa,children:B}):null,x.slice(0,I).reverse().map(o=>p.cloneElement(o,{className:E(o.props.className,h.avatar),variant:o.props.variant||A}))]})}),Ca={title:"components/Atoms/Avatar/Avatar",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{src:{control:"text"},children:{control:"text",description:"頭像內部的顯示內容，可以是string、icon"},types:{control:"select",options:["male","female","unknown"]},size:{control:"select",options:["small","medium","large","extraLarge"]},sx:{control:"object"}},args:{onClick:ra()}},d={args:{}},m={args:{alt:"A",children:"A",sx:{bgcolor:"green"}}},u={args:{alt:"image",src:"https://static.popdaily.com.tw/u/202409/0c2abc41-3d55-47d5-9727-2916bf7b2aaa.png"}},g={args:{alt:"icon",children:r.jsx(W,{}),sx:{bgcolor:"primary.main"}}},v={parameters:{docs:{source:{code:`
