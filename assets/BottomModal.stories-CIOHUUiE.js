import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{r as M}from"./index-D4H_InIO.js";import"./lemonTheme-XVakIAq2.js";import{i as y,L as x,j as m,k as u,l as h,g as I,B as d,m as o,n as v,F as B,p as L}from"./Calendar-D4VDGI_h.js";import{r as j,o as g}from"./Tray.es-C6zPdCEt.js";import{B as s,T as b}from"./IconBase.es-wFTi3CwP.js";import{L as f}from"./ListItemIcon-C7zo7YCG.js";import"./DefaultPropsProvider-BZF_OTnr.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";const H={title:"components/Modules/Modal/BottomModal",component:y,parameters:{layout:"centered",docs:{description:{component:"用手機可以用觸控上下滑動"}}},tags:["autodocs"],argTypes:{anchor:{control:"radio",options:["top","bottom"]},content:{control:"text"},actions:{control:!1}},args:{}},i={render:n=>{const[t,l]=M.useState(!1),c=()=>{l(!0)},p=()=>{l(!1)};return e.jsxs("div",{children:[e.jsx(d,{variant:"outlined",onClick:c,children:"Open alert dialog"}),e.jsx(y,{...n,open:t,onClose:p,"aria-labelledby":"alert-dialog-title","aria-describedby":"alert-dialog-description"})]})},args:{anchor:"top",title:"This is a modal title",content:e.jsxs(s,{sx:{width:250},role:"presentation",children:[e.jsx(x,{children:["Inbox","Starred","Send email","Drafts"].map((n,t)=>e.jsx(m,{disablePadding:!0,children:e.jsxs(u,{children:[e.jsx(f,{sx:{fontSize:24},children:t%2===0?e.jsx(j,{}):e.jsx(g,{})}),e.jsx(h,{primary:n})]})},n))}),e.jsx(I,{}),e.jsx(x,{children:["All mail","Trash","Spam"].map((n,t)=>e.jsx(m,{disablePadding:!0,children:e.jsxs(u,{children:[e.jsx(f,{sx:{fontSize:24},children:t%2===0?e.jsx(j,{}):e.jsx(g,{})}),e.jsx(h,{primary:n})]})},n))}),e.jsx(I,{}),e.jsx(x,{children:["All mail","Trash","Spam"].map((n,t)=>e.jsx(m,{disablePadding:!0,children:e.jsxs(u,{children:[e.jsx(f,{sx:{fontSize:24},children:t%2===0?e.jsx(j,{}):e.jsx(g,{})}),e.jsx(h,{primary:n})]})},n))})]})}},r={render:n=>{const[t,l]=M.useState(!1),c=()=>{l(!0)},p=()=>{l(!1)},W=["已入住","尚未入住"],P=["設施損壞","清潔問題","其他"],D=()=>e.jsxs(s,{component:"form",noValidate:!0,autoComplete:"off",sx:{display:"flex",flexDirection:"column",gap:2},children:[e.jsx(b,{variant:"h6",fontWeight:600,children:"說明您的問題內容"}),e.jsx(o,{fullWidth:!0,label:"您的姓名",variant:"outlined"}),e.jsx(o,{fullWidth:!0,label:"Email",variant:"outlined"}),e.jsx(o,{fullWidth:!0,label:"手機號碼",variant:"outlined",placeholder:"+886"}),e.jsxs(s,{sx:{display:"flex",gap:2},children:[e.jsx(o,{fullWidth:!0,select:!0,label:"入住狀態",variant:"outlined",children:W.map(a=>e.jsx(v,{value:a,children:a},a))}),e.jsx(o,{fullWidth:!0,select:!0,label:"問題類別",variant:"outlined",children:P.map(a=>e.jsx(v,{value:a,children:a},a))})]}),e.jsx(o,{fullWidth:!0,multiline:!0,rows:4,label:"說明內容",variant:"outlined"}),e.jsxs(s,{sx:{border:"1px dashed #ccc",borderRadius:2,p:2,textAlign:"center",color:"#666"},children:[e.jsx(b,{children:"點擊新增檔案 或拖拉"}),e.jsx(b,{variant:"caption",children:"SVG, PNG, JPG or GIF (最大 3MB)"})]}),e.jsx(B,{control:e.jsx(L,{}),label:"提供您的購物清單，更方便飯店人員回應您準確資訊"}),e.jsx(B,{control:e.jsx(L,{}),label:"我不是機器人"})]});return e.jsxs(s,{children:[e.jsx(d,{variant:"outlined",onClick:c,children:"Open alert dialog"}),e.jsx(y,{...n,open:t,onClose:p,content:e.jsx(D,{}),"aria-labelledby":"alert-dialog-title","aria-describedby":"alert-dialog-description"})]})},args:{title:"聯絡我們",align:"start",actions:e.jsxs(e.Fragment,{children:[e.jsx(d,{variant:"outlined",children:"Clear"}),e.jsx(d,{children:"Despatch"})]})}};var T,C,S;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => {
...
}`,...(O=(k=r.parameters)==null?void 0:k.docs)==null?void 0:O.source}}};const K=["Navigation","Form"];export{r as Form,i as Navigation,K as __namedExportsOrder,H as default};
