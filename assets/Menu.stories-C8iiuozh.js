...
import ListItemText from "@mui/material/ListItemText";
  ...
  return (
    ...
    `.trim()}}},render:i=>{const[t,c]=x.useState(null),l=!!t,C=m=>{c(m.currentTarget),console.log(m.currentTarget)},o=()=>{c(null)};return n.jsxs("div",{children:[n.jsx(E,{id:"basic-button","aria-controls":l?"basic-menu":void 0,"aria-haspopup":"true","aria-expanded":l?"true":void 0,onClick:C,children:"Click to Open"}),n.jsxs(I,{id:"basic-menu",anchorEl:t,open:l,onClose:o,slotProps:{list:{"aria-labelledby":"basic-button"}},sx:{"& .MuiPaper-root":{width:"200px"}},children:[n.jsxs(r,{onClick:o,selected:!0,sx:{p:2},children:[n.jsx(d,{children:n.jsx(s,{})}),"Selected"]}),n.jsx(b,{}),n.jsxs(r,{onClick:o,sx:{p:2},children:[n.jsx(d,{children:n.jsx(s,{fontSize:"small"})}),n.jsx(M,{children:"With Icon"}),n.jsx(T,{variant:"body2",children:"⌘V"})]}),n.jsx(r,{onClick:o,disabled:!0,sx:{p:2},children:"Disabled"})]})]})}};var u,p,h;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
