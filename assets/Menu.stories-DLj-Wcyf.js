...
import ListItemText from "@mui/material/ListItemText";
  ...
  return (
    ...
    `.trim()}}},render:s=>{const[t,c]=x.useState(null),a=!!t,C=m=>{c(m.currentTarget),console.log(m.currentTarget)},o=()=>{c(null)};return n.jsxs("div",{children:[n.jsx(M,{id:"basic-button","aria-controls":a?"basic-menu":void 0,"aria-haspopup":"true","aria-expanded":a?"true":void 0,onClick:C,children:"Click to Open"}),n.jsxs(I,{id:"basic-menu",anchorEl:t,open:a,onClose:o,slotProps:{list:{"aria-labelledby":"basic-button"}},sx:{"& .MuiPaper-root":{width:"200px"}},children:[n.jsxs(l,{onClick:o,selected:!0,sx:{p:2},children:[n.jsx(p,{children:n.jsx(i,{})}),"Selected"]}),n.jsx(T,{}),n.jsxs(l,{onClick:o,sx:{p:2},children:[n.jsx(p,{children:n.jsx(i,{fontSize:"small"})}),n.jsx(E,{children:"With Icon"}),n.jsx(g,{variant:"body2",children:"⌘V"})]}),n.jsx(l,{onClick:o,disabled:!0,sx:{p:2},children:"Disabled"})]})]})}};var d,u,h;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(h=(u=r.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};const de=["Label"];export{r as Label,de as __namedExportsOrder,pe as default};
