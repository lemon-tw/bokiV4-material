import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{R as u}from"./index-D4H_InIO.js";import{C as h}from"./Checkbox-C3bRZhuC.js";import{F as i}from"./FormControlLabel-rm4GDmHz.js";import"./defaultPalette-DS3qdIvj.js";import"./DefaultPropsProvider-C6ZETEwd.js";import"./memoTheme-Dxm40b6r.js";import"./Checkbox-CXs9JgyO.js";import"./SwitchBase-Ce0aYy8z.js";import"./useSlot-DpI2SreY.js";import"./useControlled-DIa7s2dv.js";import"./ButtonBase-DqDsqRqn.js";import"./createSvgIcon--HVZC8sH.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./mergeSlotProps-Dxw82FU4.js";import"./Typography-2UsIpkSH.js";import"./index-C958WKz4.js";import"./useTheme-CgXM_xl0.js";import"./extendSxProp-CjEWOyj5.js";const c=({labels:t,parentLabel:p="全選"})=>{const[a,l]=u.useState(Array(t.length).fill(!1)),s=a.every(Boolean),b=a.some(Boolean)&&!s,g=n=>{l(Array(t.length).fill(n.target.checked))},x=n=>o=>{const d=[...a];d[n]=o.target.checked,l(d)};return e.jsxs(e.Fragment,{children:[e.jsx(i,{label:p,control:e.jsx(h,{checked:s,indeterminate:b,onChange:g})}),t.map((n,o)=>e.jsx(i,{label:n,control:e.jsx(h,{style:{marginLeft:"48px"},checked:a[o],onChange:x(o)})},n))]})};c.__docgenInfo={description:"",methods:[],displayName:"CheckboxGroup",props:{labels:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"子項目標籤陣列"},parentLabel:{required:!1,tsType:{name:"string"},description:"父層標籤（可選）",defaultValue:{value:'"全選"',computed:!1}}}};const V={title:"Components/Checkbox/CheckboxGroup",component:c,tags:["autodocs"],parameters:{layout:"centered"},argTypes:{parentLabel:{control:"text"},labels:{control:"object"}},args:{parentLabel:"父層",labels:["子項目1","子項目2"]}},r={render:t=>e.jsx(c,{...t}),parameters:{docs:{source:{code:`
...
}`,...(k=(C=r.parameters)==null?void 0:C.docs)==null?void 0:k.source}}};const z=["Standard"];export{r as Standard,z as __namedExportsOrder,V as default};
