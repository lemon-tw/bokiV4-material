...
}`,...(S=(C=s.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var F,k,O;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(false);
    const handleClickOpen = () => {
      setOpen(true);
...
}`,...(O=(k=i.parameters)==null?void 0:k.docs)==null?void 0:O.source}}};const H=["Navigation","Form"];export{i as Form,s as Navigation,H as __namedExportsOrder,q as default};
