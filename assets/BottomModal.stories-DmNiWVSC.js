...
}`,...(S=(C=i.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var F,O,k;r.parameters={...r.parameters,docs:{...(F=r.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
    const [open, setOpen] = useState(false);
    const handleClickOpen = () => {
      setOpen(true);
...
}`,...(k=(O=r.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};const q=["Navigation","Form"];export{r as Form,i as Navigation,q as __namedExportsOrder,_ as default};
