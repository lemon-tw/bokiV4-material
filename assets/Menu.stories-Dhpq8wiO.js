...
import ListItemText from "@mui/material/ListItemText";
  ...
  return (
    ...
    `.trim()}}},render:i=>{const[t,c]=x.useState(null),r=!!t,C=m=>{c(m.currentTarget),console.log(m.currentTarget)},o=()=>{c(null)};return n.jsxs("div",{children:[n.jsx(M,{id:"basic-button","aria-controls":r?"basic-menu":void 0,"aria-haspopup":"true","aria-expanded":r?"true":void 0,onClick:C,children:"Click to Open"}),n.jsxs(I,{id:"basic-menu",anchorEl:t,open:r,onClose:o,slotProps:{list:{"aria-labelledby":"basic-button"}},sx:{"& .MuiPaper-root":{width:"200px"}},children:[n.jsxs(l,{onClick:o,selected:!0,sx:{p:2},children:[n.jsx(p,{children:n.jsx(s,{})}),"Selected"]}),n.jsx(T,{}),n.jsxs(l,{onClick:o,sx:{p:2},children:[n.jsx(p,{children:n.jsx(s,{fontSize:"small"})}),n.jsx(E,{children:"With Icon"}),n.jsx(g,{variant:"body2",children:"⌘V"})]}),n.jsx(l,{onClick:o,disabled:!0,sx:{p:2},children:"Disabled"})]})]})}};var d,u,h;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(h=(u=a.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};const J=["Label"];export{a as Label,J as __namedExportsOrder,G as default};
