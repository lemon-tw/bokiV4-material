import{j as s}from"./jsx-runtime-BO8uF4Og.js";import{r as e}from"./index-D4H_InIO.js";import"./lemonTheme-CzmFcrQX.js";import"./Cart-CqyQqfjd.js";import"./Profile-CriQQtvK.js";import{B as k}from"./ToggleButton-oZXW10Qn.js";import{G as S}from"./Calendar-ARKOzniF.js";import"./BottomModal-BGRPiAzg.js";import"./DefaultPropsProvider-BUHaCmAf.js";import"./CheckCircle.es-CWUap0Ir.js";import"./index-Bm8UbI65.js";import"./Copy.es-C9oN9lTh.js";import"./getThemeProps-BwdQ335V.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";import"./Tabs-DUc-6XiH.js";const te={title:"components/Atoms/GuestRoomConfig/GuestRoomConfig",component:S,parameters:{layout:"centered",controls:{exclude:["isMultiRoomPackage","setIsMultiRoomPackage","numRooms","setNumRooms","seniors","setSeniors","seniorsArray","setSeniorsArray","childrens","setChildrens","childrensArray","setChildrensArray","adults","setAdults","pets","setPets","petsArray","setPetsArray","accessibleRoom","setAccessibleRoom"]}},tags:["autodocs"],argTypes:{childrensSelectorType:{control:"radio",options:["age","height"]}},args:{}},n={render:a=>{const[t,o]=e.useState(null),[l,c]=e.useState(!1),[i,u]=e.useState(1),[m,h]=e.useState(1),[d,p]=e.useState(0),[A,R]=e.useState(0),[w,b]=e.useState([]),[M,B]=e.useState([]),[x,T]=e.useState(0),[v,N]=e.useState([]),[j,G]=e.useState(!1),L=O=>{o(O.currentTarget)},W=()=>{o(null)},I=!!t;return s.jsxs(s.Fragment,{children:[s.jsx(k,{onClick:L,children:"Open popover"}),s.jsx(S,{open:I,anchorEl:t,onClose:W,isMultiRoomPackage:l,setIsMultiRoomPackage:c,numRooms:i,setNumRooms:u,adults:m,setAdults:h,childrens:d,setChildrens:p,seniors:A,setSeniors:R,seniorsArray:w,setSeniorsArray:b,childrensArray:M,setChildrensArray:B,pets:x,setPets:T,petsArray:v,setPetsArray:N,accessibleRoom:j,setAccessibleRoom:G,...a})]})},args:{showSeniors:!0,showChildrens:!0,showMultiRoomPackage:!0,showAge:!0,showPets:!0,childrensSelectorType:"height"}},r={render:a=>{const[t,o]=e.useState(null),[l,c]=e.useState(1),[i,u]=e.useState(1),[m,h]=e.useState(!1),d=R=>{o(R.currentTarget)},p=()=>{o(null)},A=!!t;return s.jsxs(s.Fragment,{children:[s.jsx(k,{onClick:d,children:"Open popover"}),s.jsx(S,{open:A,anchorEl:t,onClose:p,numRooms:l,setNumRooms:c,adults:i,setAdults:u,accessibleRoom:m,setAccessibleRoom:h,...a})]})},args:{}};var g,P,C;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...
  args: {}
}`,...(f=(E=r.parameters)==null?void 0:E.docs)==null?void 0:f.source}}};const oe=["ShowAllProps","ShowLessProps"];export{n as ShowAllProps,r as ShowLessProps,oe as __namedExportsOrder,te as default};
