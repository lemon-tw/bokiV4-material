import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{fn as ta}from"./index-Cf3xVBfy.js";import{u as ra}from"./DefaultPropsProvider-RK5HW-AM.js";import{a5 as sa,a6 as ea,a7 as oa,a8 as na,s as ca,p as P,q as ia,u as la,a9 as pa,A as n,a1 as W}from"./Header-B-sHNX6_.js";import{r as p}from"./index-D4H_InIO.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";function da(a){return ea("MuiAvatarGroup",a)}const ma=sa("MuiAvatarGroup",["root","avatar"]),y={small:-16,medium:-8},ua=a=>{const{classes:s}=a;return ia({root:["root"],avatar:["avatar"]},da,s)},ga=ca("div",{name:"MuiAvatarGroup",slot:"Root",overridesResolver:(a,s)=>[{[`& .${ma.avatar}`]:s.avatar},s.root]})(la(({theme:a})=>({display:"flex",flexDirection:"row-reverse",[`& .${pa.root}`]:{border:`2px solid ${(a.vars||a).palette.background.default}`,boxSizing:"content-box",marginLeft:"var(--AvatarGroup-spacing, -8px)","&:last-child":{marginLeft:0}}}))),va=p.forwardRef(function(s,w){const G=ra({props:s,name:"MuiAvatarGroup"}),{children:Y,className:L,component:C="div",componentsProps:c,max:b=5,renderSurplus:R,slotProps:S={},slots:D={},spacing:F="medium",total:B,variant:A="circular",...j}=G;let e=b<2?2:b;const r={...G,max:b,spacing:F,component:C,variant:A},h=ua(r),x=p.Children.toArray(Y).filter(o=>p.isValidElement(o)),i=B||x.length;i===e&&(e+=1),e=Math.min(i+1,e);const I=Math.min(x.length,e-1),f=Math.max(i-e,i-I,0),H=R?R(f):`+${f}`;let l;r.spacing&&y[r.spacing]!==void 0?l=y[r.spacing]:r.spacing===0?l=0:l=-r.spacing||y.medium;const X={slots:D,slotProps:{surplus:S.additionalAvatar??(c==null?void 0:c.additionalAvatar),...c,...S}},[Z,aa]=oa("surplus",{elementType:na,externalForwardedProps:X,className:h.avatar,ownerState:r,additionalProps:{variant:A}});return t.jsxs(ga,{as:C,ownerState:r,className:P(h.root,L),ref:w,...j,style:{"--AvatarGroup-spacing":`${l}px`,...j.style},children:[f?t.jsx(Z,{...aa,children:H}):null,x.slice(0,I).reverse().map(o=>p.cloneElement(o,{className:P(o.props.className,h.avatar),variant:o.props.variant||A}))]})}),Ca={title:"components/Atoms/Avatar/Avatar",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{src:{control:"text"},children:{control:"text",description:"頭像內部的顯示內容，可以是string、icon"},types:{control:"select",options:["male","female","unknown"]},size:{control:"select",options:["small","medium","large","extraLarge"]},sx:{control:"object"}},args:{onClick:ta()}},d={args:{}},m={args:{alt:"A",children:"A",sx:{bgcolor:"green"}}},u={args:{alt:"image",src:"https://static.popdaily.com.tw/u/202409/0c2abc41-3d55-47d5-9727-2916bf7b2aaa.png"}},g={args:{alt:"icon",children:t.jsx(W,{}),sx:{bgcolor:"primary.main"}}},v={parameters:{docs:{source:{code:`
...
}`,...(q=($=g.parameters)==null?void 0:$.docs)==null?void 0:q.source}}};var T,z,Q;v.parameters={...v.parameters,docs:{...(T=v.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
