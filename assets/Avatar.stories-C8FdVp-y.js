import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{fn as ta}from"./index-Cf3xVBfy.js";import"./lemonTheme-Cff-IwOP.js";import"./Cart-Bggd5MJL.js";import{a as ra,b as sa,A as n,o as W}from"./Profile-LD9QASci.js";import"./ToggleButton-nmKaFVRX.js";import"./Calendar-De-M7FAW.js";import{u as ea}from"./BottomModal-CO6eF4lz.js";import{r as l}from"./index-D4H_InIO.js";import{g as oa,d as na,s as ca,c as P,a as ia,m as pa}from"./CheckCircle.es-CCP3thZb.js";import{u as la}from"./DefaultPropsProvider-BaK2E95z.js";import"./index-Bm8UbI65.js";import"./index-Dgl_MXap.js";import"./getThemeProps-CgMh0Kv1.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";import"./Tabs-QawvxuqF.js";import"./Copy.es-Dlh5z7f2.js";function ma(a){return na("MuiAvatarGroup",a)}const da=oa("MuiAvatarGroup",["root","avatar"]),y={small:-16,medium:-8},ua=a=>{const{classes:s}=a;return ia({root:["root"],avatar:["avatar"]},ma,s)},ga=ca("div",{name:"MuiAvatarGroup",slot:"Root",overridesResolver:(a,s)=>[{[`& .${da.avatar}`]:s.avatar},s.root]})(pa(({theme:a})=>({display:"flex",flexDirection:"row-reverse",[`& .${sa.root}`]:{border:`2px solid ${(a.vars||a).palette.background.default}`,boxSizing:"content-box",marginLeft:"var(--AvatarGroup-spacing, -8px)","&:last-child":{marginLeft:0}}}))),va=l.forwardRef(function(s,w){const G=la({props:s,name:"MuiAvatarGroup"}),{children:Y,className:L,component:C="div",componentsProps:c,max:b=5,renderSurplus:R,slotProps:S={},slots:D={},spacing:F="medium",total:B,variant:A="circular",...j}=G;let e=b<2?2:b;const r={...G,max:b,spacing:F,component:C,variant:A},h=ua(r),x=l.Children.toArray(Y).filter(o=>l.isValidElement(o)),i=B||x.length;i===e&&(e+=1),e=Math.min(i+1,e);const I=Math.min(x.length,e-1),f=Math.max(i-e,i-I,0),H=R?R(f):`+${f}`;let p;r.spacing&&y[r.spacing]!==void 0?p=y[r.spacing]:r.spacing===0?p=0:p=-r.spacing||y.medium;const X={slots:D,slotProps:{surplus:S.additionalAvatar??(c==null?void 0:c.additionalAvatar),...c,...S}},[Z,aa]=ea("surplus",{elementType:ra,externalForwardedProps:X,className:h.avatar,ownerState:r,additionalProps:{variant:A}});return t.jsxs(ga,{as:C,ownerState:r,className:P(h.root,L),ref:w,...j,style:{"--AvatarGroup-spacing":`${p}px`,...j.style},children:[f?t.jsx(Z,{...aa,children:H}):null,x.slice(0,I).reverse().map(o=>l.cloneElement(o,{className:P(o.props.className,h.avatar),variant:o.props.variant||A}))]})}),Ja={title:"components/Atoms/Avatar/Avatar",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{src:{control:"text"},children:{control:"text",description:"頭像內部的顯示內容，可以是string、icon"},types:{control:"select",options:["male","female","unknown"]},size:{control:"select",options:["small","medium","large","extraLarge"]},sx:{control:"object"}},args:{onClick:ta()}},m={args:{}},d={args:{alt:"A",children:"A",sx:{bgcolor:"green"}}},u={args:{alt:"image",src:"https://static.popdaily.com.tw/u/202409/0c2abc41-3d55-47d5-9727-2916bf7b2aaa.png"}},g={args:{alt:"icon",children:t.jsx(W,{}),sx:{bgcolor:"primary.main"}}},v={parameters:{docs:{source:{code:`
...
}`,...(Q=(z=v.parameters)==null?void 0:z.docs)==null?void 0:Q.source}}};const Ka=["defaultAvarta","InitialAvata","ImageAvata","IconAvata","groupAvata"];export{g as IconAvata,u as ImageAvata,d as InitialAvata,Ka as __namedExportsOrder,Ja as default,m as defaultAvarta,v as groupAvata};
