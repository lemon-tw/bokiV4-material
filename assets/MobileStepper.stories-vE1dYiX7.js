import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{R as v}from"./index-D4H_InIO.js";import"./lemonTheme-DbLJfmwh.js";import{k as x}from"./Calendar-DGseMECJ.js";import{B as i}from"./Profile-BgdNPY20.js";import{t as c}from"./BottomModal-Dlt3Pqpu.js";import{u as m,B as g,P as N,T,e as p}from"./CaretRight.es-CgghsZ2Q.js";import"./DefaultPropsProvider-BtL_yMcr.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";const O={title:"components/Modules/Stepper/MobileStepper",component:x,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{},args:{}},d={render:S=>{const a=[{label:"Select campaign settings",description:`For each ad campaign that you create, you can control how much
              ...
              they're running and how to resolve approval issues.`}],n=m(),[e,s]=v.useState(0),r=a.length,o=()=>{s(u=>u+1)},I=()=>{s(u=>u-1)};return t.jsxs(g,{sx:{maxWidth:400,flexGrow:1},children:[t.jsx(N,{square:!0,elevation:0,sx:{display:"flex",alignItems:"center",height:50,pl:2,bgcolor:"background.default"},children:t.jsx(T,{children:a[e].label})}),t.jsx(g,{sx:{height:255,maxWidth:400,width:"100%",p:2},children:a[e].description}),t.jsx(x,{variant:"text",steps:r,position:"static",activeStep:e,nextButton:t.jsxs(i,{variant:"text",onClick:o,disabled:e===r-1,children:["Next",n.direction==="rtl"?t.jsx(c,{}):t.jsx(p,{})]}),backButton:t.jsxs(i,{variant:"text",onClick:I,disabled:e===0,children:[n.direction==="rtl"?t.jsx(p,{}):t.jsx(c,{}),"Back"]})})]})}},l={render:S=>{const a=m(),[n,e]=v.useState(0),s=()=>{e(o=>o+1)},r=()=>{e(o=>o-1)};return t.jsx(x,{variant:"dots",steps:6,position:"static",activeStep:n,sx:{maxWidth:400,flexGrow:1},nextButton:t.jsxs(i,{variant:"text",onClick:s,disabled:n===5,children:["Next",a.direction==="rtl"?t.jsx(c,{}):t.jsx(p,{})]}),backButton:t.jsxs(i,{variant:"text",onClick:r,disabled:n===0,children:[a.direction==="rtl"?t.jsx(p,{}):t.jsx(c,{}),"Back"]})})}},h={render:S=>{const a=m(),[n,e]=v.useState(0),s=()=>{e(o=>o+1)},r=()=>{e(o=>o-1)};return t.jsx(x,{variant:"progress",steps:6,position:"static",activeStep:n,sx:{maxWidth:800,flexGrow:1},nextButton:t.jsxs(i,{variant:"text",onClick:s,disabled:n===5,sx:{width:"140px"},children:["Next",a.direction==="rtl"?t.jsx(c,{}):t.jsx(p,{})]}),backButton:t.jsxs(i,{variant:"text",onClick:r,disabled:n===0,sx:{width:"140px"},children:[a.direction==="rtl"?t.jsx(p,{}):t.jsx(c,{}),"Back"]})})}};var B,k,b;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
    const steps = [{
...
}`,...(A=(j=h.parameters)==null?void 0:j.docs)==null?void 0:A.source}}};const z=["Text","Dots","Progress"];export{l as Dots,h as Progress,d as Text,z as __namedExportsOrder,O as default};
