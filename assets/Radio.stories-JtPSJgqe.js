import{j as r}from"./jsx-runtime-BO8uF4Og.js";import{R as U}from"./index-D4H_InIO.js";import"./lemonTheme-DbLJfmwh.js";import{H as a}from"./Calendar-DGseMECJ.js";import"./Profile-BgdNPY20.js";import"./BottomModal-Dlt3Pqpu.js";import"./DefaultPropsProvider-BtL_yMcr.js";import"./CaretRight.es-CgghsZ2Q.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";import"./tiny-invariant-CopsF_GD.js";const B={title:"Components/Atoms/Radio/Radio",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{color:{control:{type:"select"},options:["primary"]},label:{control:"text"},disabled:{control:"boolean"}},args:{}},j=e=>{const[D,y]=U.useState(!1),L=T=>{y(T.target.checked)};return r.jsx(a,{...e,checked:D,onChange:L})},s={render:e=>r.jsx(j,{...e}),parameters:{docs:{source:{code:`
<Radio />`.trim()}}}},o={render:e=>r.jsx(j,{...e,label:"Standard 樣式"}),parameters:{docs:{source:{code:`
...
}`,...(k=(C=n.parameters)==null?void 0:C.docs)==null?void 0:k.source}}};const F=["Standard","WithLabel","Uncontrolled","UncontrolledWithLabel","Disabled"];export{n as Disabled,s as Standard,t as Uncontrolled,d as UncontrolledWithLabel,o as WithLabel,F as __namedExportsOrder,B as default};
