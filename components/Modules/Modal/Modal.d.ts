...
export declare const Modal: ({ icon, title, content, actions, size, align, deviceType, hideCloseButton, ...props }: CustomModalProps) => import("react/jsx-runtime").JSX.Element;
