...
export declare const pendingWaitListHeader: {
    title: string;
...
export declare const pendingWaitListContactInfo: BookingGuestContactInfo;
...
export declare const pendingWaitListHeaderInfo: PaymentInfo;
export declare const pendingWaitListOrderContent: OrderContentInfo;
