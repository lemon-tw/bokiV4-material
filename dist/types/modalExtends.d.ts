...
export interface CustomSideModalProps extends Omit<MuiDrawerprops, "content" | "anchor"> {
    title?: string;
    /** Modal內容對其位置 */
    align?: "start" | "center";
    /** Modal的內容，可以是字串或ReactNode */
...
export interface CustomBottomModalProps extends Omit<MuiSwipeableDrawerprops, "content" | "anchor"> {
    title?: string;
    /** Modal內容對其位置 */
    align?: "start" | "center";
    /** Modal的內容，可以是字串或ReactNode */
