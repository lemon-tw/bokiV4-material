...
const StyledButton = styled(MuiButton)(({ "data-variant": variant, size = "medium", theme, "data-color": color = "primary", }) => {
...
export const Button = ({ variant = "filled", color = "primary", ...rest }) => {
    return (_jsx(StyledButton, { disableElevation: true, disableRipple: true, ...rest, "data-color": color, "data-variant": variant }));
};
