...
export const Rating: React.FC<RatingProps> = ({
    ...
    return (
        <span
            style={{ display: "inline-flex", alignItems: "center", cursor: readOnly || disabled ? "default" : "pointer" }}
        ...
        >
            {stars.map((_, i) => {
                ...
                return (
                    <span
                        key={i}
                        style={{ position: "relative", width: iconSize, height: iconSize, display: "inline-block" }}
                        onMouseMove={e => handleMouseMove(i, e)}
                        onClick={e => handleClick(i, e)}
                    >
                        <CiStar size={iconSize} style={{ position: "absolute", left: 0, top: 0, color: "#bbb" }} />
                        <span
                            style={{
                                width: `${fill * 100}%`,
                                overflow: "hidden",
                        ...
                        >
                            <FaStar size={iconSize} style={{ color: "#FFD700" }} />
                        </span>
                    </span>
                );
            })}
